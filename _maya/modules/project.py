...
class MBProject:
    ...
    def create_structure(self, project=None):
        folders = ['asset', 'cache', 'images', 'movies', 'scenes', 'sourceimages', 'work', 'work/assets/00_Character/Char', 'work/scenes/SC01/SHOT_010']
        ...
        project.update({"structure": True})
        path = os.path.join(project.get("path"), 'data', 'project.yml')
        util.storage(project, path, replace=True)
        self.parent.refresh()