...
# from D:\DEVELOP\Studios\Notan\Dev\env\lib\site-packages\PIL\_imagingcms.cp37-win_amd64.pyd
# by generator 1.147
# no doc
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000002D0631923C8>'

__spec__ = None # (!) real value is "ModuleSpec(name='PIL._imagingcms', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000002D0631923C8>, origin='D:\\\\DEVELOP\\\\AssetGallery\\\\Python\\\\venv\\\\lib\\\\site-packages\\\\PIL\\\\_imagingcms.cp37-win_amd64.pyd')"
